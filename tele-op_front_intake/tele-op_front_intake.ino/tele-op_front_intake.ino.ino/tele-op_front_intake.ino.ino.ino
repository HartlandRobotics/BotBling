...
int     L, o = 0, intake = 1, set = 0, n = 0, SPEED = 10, head, tail, temp = 0, head2 = head + 1, tail2 = head2 + LENGTHl, 
...
void loop() {
  ...
  for(o = NUMPIXELS - 4;o < NUMPIXELS;o++){
  if(intake == 1){
  strip.setPixelColor(o, 0);
    }
  }
  ...
  for(o = 0;o < SHORT + 4;o++){
  if(intake == 1){
  strip.setPixelColor(o, color.color1);
  } 
  }
  for(o = NUMPIXELS - 4;o < NUMPIXELS;o++){
  if(intake == 1){
  ...
  head2 = (int) ((1 - headfloat) * (LONG-4) + SHORT + 4);
  head3 = (int) (headfloat * SHORT + SHORT + LONG);
  head4 = (int) ((1 - headfloat) * (LONG - 4) + 2 * SHORT + LONG);
  tail = head - LENGTHs;
  tail2 = head2 + LENGTHl - 2;
  tail3 = head3 - LENGTHs;
  tail4 = head4 + LENGTHl - 2;
  ...
  for(o = SHORT + LONG - 4;o < 2 * SHORT + LONG + 4;o++){
  if(intake == 1){
  strip.setPixelColor(o, 0);
    } 
  }
  ...
  if(head >= tail){
  head = (int) (headfloat * SHORT);
  head2 = (int) ((1 - headfloat) * (LONG - 4) + SHORT);
  head3 = (int) (headfloat * SHORT + SHORT + LONG);
  head4 = (int) ((1 - headfloat) * (LONG - 4) + 2 * SHORT + LONG + 4);
  tail = head - LENGTHs;
  tail2 = head2 + LENGTHl - 2;
  tail3 = head3 - LENGTHs;
  tail4 = head4 + LENGTHl - 2;
